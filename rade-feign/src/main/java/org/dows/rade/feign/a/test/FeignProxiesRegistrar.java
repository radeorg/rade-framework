...
class FeignProxiesRegistrar implements ImportBeanDefinitionRegistrar,
    ...
    // FeignClient.class
    @Value("${feign.client.class}")
    private Class<? extends Annotation> filterClientClass;
    ...
    public void registerFeignClients(AnnotationMetadata metadata,
        ...
        AnnotationTypeFilter annotationTypeFilter = new AnnotationTypeFilter(filterClientClass);
